import { action, computed, extendShallowObservable, extras, intercept, isComputed, isObservable, isObservableArray, observable, observe, reaction, runInAction } from 'mobx';
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            ...
            _this.forAllProps(function (name, type) {
                extendShallowObservable(instance, (_a = {},
                    _a[name] = observable.ref(type.instantiate(objNode, name, objNode._environment, snapshot[name])),
                    _a));
