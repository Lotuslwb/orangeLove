...
function getMembers$$1(target) {
    ...
    props.forEach(function (key) {
        ...
        else if (mobx.isObservable(target, key))
            reflected.volatile.push(key);
        else
            reflected.views.push(key);
    });
...
var MapType$$1 = /** @class */ (function (_super) {
    ...
    function MapType$$1(name, subType) {
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            ...
            mobx.extras.interceptReads(instance, objNode.unbox);
...
var ArrayType$$1 = /** @class */ (function (_super) {
    ...
    function ArrayType$$1(name, subType) {
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            var objNode = node;
            var instance = objNode.storedValue;
            mobx.extras.getAdministration(instance).dehancer = objNode.unbox;
        ...
        _this.finalizeNewInstance = function (node, snapshot) {
            ...
            _this.forAllProps(function (name, type) {
                mobx.extendShallowObservable(instance, (_a = {},
                    _a[name] = mobx.observable.ref(type.instantiate(objNode, name, objNode._environment, snapshot[name])),
                    _a));
                mobx.extras.interceptReads(instance, name, objNode.unbox);
                var _a;
            });
