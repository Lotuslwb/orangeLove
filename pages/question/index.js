...
import {
    ...
    TextareaItem, Calendar, Card, DatePickerView, DatePicker, Modal, ActivityIndicator
} from 'antd-mobile';
            ...
            <div className={styles.page}>
                ...
                <div className={styles.card}>
                    <div className={styles.card__body}>
                        <div
                            className={styles.question}>{questionIndex + 1}. {question.name}</div>
                        <div onClick={this.handleChoose.bind(this, question, 'A')}
                             className={'A' === answerMap[question.id] ? styles.answer__chosen : styles.answer}>完全能做到
                        </div>
                        <div onClick={this.handleChoose.bind(this, question, 'B')}
                             className={'B' === answerMap[question.id] ? styles.answer__chosen : styles.answer}>有时能做到，有时不能做到
                        </div>
                        <div onClick={this.handleChoose.bind(this, question, 'C')}
                             className={'C' === answerMap[question.id] ? styles.answer__chosen : styles.answer}>完全做不到
                        </div>
                        <div onClick={this.handleChoose.bind(this, question, 'D')}
                             className={'D' === answerMap[question.id] ? styles.answer__chosen : styles.answer}>不清楚
                        </div>
                    </div>
                ...
                <div className={styles.step}>
                    <div onClick={this.handlePrev} className={styles.prev}>上一题</div>
                    <div className={styles.center}></div>
                    <div onClick={this.handleNext} className={styles.next}>下一题</div>
                </div>
            </div>
        )
    }
